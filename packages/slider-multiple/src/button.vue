...
<div style="display:inline-block;vertical-align: middle;">
  <div class="el-slider-multi__bar" :style="barStyle">
    <div class="el-slider-multi__bar-text" :class="{'bar-text-red':percent==0}">{{percent}}%</div>
  </div>
  <div
    class="el-slider-multi__button-wrapper"
    @mouseenter="handleMouseEnter"
    @mouseleave="handleMouseLeave"
    @mousedown="onButtonDown"
    :class="{ 'hover': hovering, 'dragging': dragging, 'nodrag': index==limits.length-1 }"
    :style="wrapperStyle"
    ref="button">
    <el-tooltip placement="top" ref="tooltip" :disabled="!showTooltip">
      <span slot="content">{{ formatValue }}</span>
      <div class="el-slider-multi__button" :class="{ 'hover': hovering, 'dragging': dragging, 'nodrag': index==limits.length-1 }">
        <span class="el-slider-multi__label">{{label}}</span>
      </div>
    </el-tooltip>
    <div class="el-slider-multi__desc">
