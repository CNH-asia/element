<template>
  <div class="el-slider-multi">
    <div class="el-slider-multi__runway"
      ...
      <slider-multiple-button
        ...
        :no-drag="index==buttons.length-1"
        :limits="limits"
        :index="index"
...
<script type="text/babel">
  ...
  import SliderMultipleButton from './button.vue';
  import Emitter from 'element-ui/src/mixins/emitter';

  export default {
    name: 'ElSliderMultiple',
    ...
    mounted() {
      var that = this;
      if(!this.value || this.value.length !== this.buttons.length) {
        var sum0 = 0;
        that.buttons.forEach(function(btn,index) {
